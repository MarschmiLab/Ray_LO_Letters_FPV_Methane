...
save(water_ch4_physeq, file = "data/water_ch4_physeq.RData")
...
save(water_physeq_ch4_order, file = "data/water_physeq_ch4_order.RData")

# write out to excel file for plotting main figure
write.csv(methano_water_df, "data/watercol_microbial_communities.csv")
```
We created:
...
# save .RData
save(methano_sed_df, file = "data/methano_sed_df.RData")


# write out to excel file 
write.csv(methano_sed_df, "data/sed_microbial_communities.csv")
...
# save phyloseq object
save(scaled_sed_ch4_physeq, file = "data/scaled_sed_ch4_physeq.RData")
...
# save .RData
save(methanogen_sed_df, file = "data/methanogen_sed_df.RData")
...
# save phyloseq object
save(scaled_methanogen_sed_physeq, file = "data/scaled_methanogen_sed_physeq.RData")
```
We created:
...
# save .RData
save(methanotroph_sed_df, file = "data/methanotroph_sed_df.RData")
...
# save phyloseq object
save(scaled_methanotroph_sed_physeq, file = "data/scaled_methanotroph_sed_physeq.RData")
```
We created:
...
# write the code to save this i just had manually saved it before
```
...
load("data/water_ch4_asv_output.RData")
