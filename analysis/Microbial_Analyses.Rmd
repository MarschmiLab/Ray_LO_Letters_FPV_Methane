...
pacman::p_load(phyloseq, ggpubr, tidyverse, patchwork, ggh4x, speedyseq, rstatix, dplyr, purrr, vegan, ANCOMBC, microViz,  cowplot, grid, scales, Biostrings, stringr, lmerTest, ggtext, install = FALSE)
...
### Plot DO vs Abundance overtime
```{r do-abundance-ot}
load("data/00_load_data/chem_metadata_23_24.RData")

# join with chem metadata with abundance data

do_abundance <- left_join(water_ch4_cyclers_df, chem_metadata_23_24, by = "DNA_ID")

# plot DO mg/L overtime
do_mgl <- do_abundance %>% 
