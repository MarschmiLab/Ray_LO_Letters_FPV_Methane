...
pacman::p_load(phyloseq, ggpubr, tidyverse, patchwork, ggh4x, speedyseq, rstatix, dplyr, purrr, vegan, ANCOMBC, cowplot, grid, scales, install = FALSE)
...
### Water 
lets do a little experiment first with the water_physeq. this has data from both years and maybe the reason why its not matching up to my combined two year analysis is that i subset the years?

I htink i figured it out, i probably need to filter by ach year separately 
...
# prune taxa, defitely significant reduction in asvs (updated: 15464) (old:15427 compared to 24931)
...
save(water_ch4_physeq_24, file = "data/01_phyloseq/water_ch4_physeq_24.RData")
