...
**Combined** 
```{r Fig-S5-combined-alphas-gammas, fig.width = 6, fig.height = 8}
...
```{r CalcBrayCurtis-water-methanogens-and-trophs, warning = TRUE}
# All Water column! 
...
```{r Fig-S8-sed-methotrophs-time, fig.width = 8, fig.height = 5}
# Pull top time-divergent ASVs and remove the weak/noisy or moderate
